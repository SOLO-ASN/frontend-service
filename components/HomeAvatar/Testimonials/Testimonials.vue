          ...
          <slider-art :fade="fade">
            ...
            >
              <div class="avatar-art">
                <v-avatar style="top: 120px; left: 240px" class="avatar" :image="imgAPI.avatar[30]" alt="decoration" />
                <v-avatar style="top: 220px; left: 80px" class="avatar" :image="imgAPI.avatar[11]" alt="decoration" />
                <v-avatar style="top: 280px; left: 340px" class="avatar" :image="imgAPI.avatar[33]" alt="decoration" />
                <v-avatar style="top: 380px; left: 100px" class="avatar" :image="imgAPI.avatar[28]" alt="decoration" />
                <v-avatar style="top: 460px; left: 300px" class="avatar" :image="imgAPI.avatar[32]" alt="decoration" />
              </div>
            </div>
          </slider-art>
        </div>
