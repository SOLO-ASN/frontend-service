    ...
    <div class="flowers">
      ...
      >
        <kinesis-element
          ...
          tag="div"
        >
          <div style="top: 470px; left: -240px" class="obj-hover snail">
            <clay-deco img="/images/decoration/clay-snail.png" color="double-primary" />
          </div>
        </kinesis-element>
        <kinesis-element
          :strength="70"
          ...
          tag="div"
        >
          <div style="left: -60px; top: 260px" class="obj-hover tornado">
            <clay-deco img="/images/decoration/clay-tornado.png" color="accent" />
          </div>
        </kinesis-element>
        <kinesis-element
          :strength="20"
          ...
          tag="div"
        >
          <div style="right: 0px; top: 320px" class="obj-hover flower">
            <clay-deco img="/images/decoration/clay-flower.png" color="secondary-dark" />
          </div>
        </kinesis-element>
        <kinesis-element
          :strength="20"
        ...
        >
          <div style="right: -200px; top: 250px" class="obj-hover bom">
            <clay-deco img="/images/decoration/clay-bom.png" color="secondary-light" />
          </div>
        </kinesis-element>
        <kinesis-element
          :strength="40"
      ...
      <div class="inner-parallax start">
        <div v-if="loaded" class="obj-scroll">
          <scroll-parallax :speed="0.15" direction="y">
            <div style="left: 0; top: 80px" class="snail">
              <clay-deco img="/images/decoration/clay-snail.png" color="double-primary" />
            </div>
          </scroll-parallax>
        </div>
        <div v-if="loaded" class="obj-scroll">
          <scroll-parallax :speed="0.15" direction="y">
            <div style="left: 150px; top: -100px" class="tornado">
              <clay-deco img="/images/decoration/clay-tornado.png" color="accent" />
            </div>
          </scroll-parallax>
        </div>
